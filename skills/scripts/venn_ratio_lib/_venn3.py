...
from ._math import circle_circle_intersection, NUMERIC_TOLERANCE, Point2D
from ._common import VennDiagram, prepare_venn_axes, mix_colors
from ._region import VennRegion, VennCircleRegion, VennEmptyRegion
from .layout.api import VennLayout, VennLayoutAlgorithm
from .layout.venn3 import DefaultLayoutAlgorithm
...
def venn3_circles(
    ...
    **kwargs
    ...
    Args:
        ...
        layout_algorithm: The layout algorithm to be used. Defaults to libvennratio.layout.venn3.DefaultLayoutAlgorithm(normalize_to).
    ...
    if normalize_to is not None:
        if layout_algorithm is None:
            warnings.warn(
                "normalize_to is deprecated. Please use layout_algorithm=libvennratio.layout.venn3.DefaultLayoutAlgorithm(normalize_to) instead."
            )
        else:
            raise ValueError(
...
def venn3(
    ...
    Args:
        ...
        normalize_to: Deprecated. Use normalize_to argument of libvennratio.layout.venn3.DefaultLayoutAlgorithm instead.
        ...
        layout_algorithm: The layout algorithm to determine the scale and position of the three circles. Defaults to
            libvennratio.layout.venn3.DefaultLayoutAlgorithm().

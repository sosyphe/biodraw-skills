...
import warnings
from ._venn2 import venn2
from ._venn3 import venn3
from .layout.venn2 import DefaultLayoutAlgorithm as Venn2Layout
from .layout.venn3 import DefaultLayoutAlgorithm as Venn3Layout
...
def venn2_unweighted(
    ...
    Use venn2(..., layout_algorithm=libvennratio.layout.venn2.DefaultLayoutAlgorithm(fixed_subset_sizes=(1,1,1))) instead.
    """
    warnings.warn(
...
def venn3_unweighted(
    ...
    """
    This function is deprecated and will be removed in a future version.
    Use venn3(..., layout_algorithm=libvennratio.layout.venn3.DefaultLayoutAlgorithm(fixed_subset_sizes=(1,1,1,1,1,1,1))) instead.
    """
    warnings.warn(

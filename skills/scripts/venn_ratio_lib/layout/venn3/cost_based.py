...
>>> from libvennratio.layout.venn3 import cost_based
>>> from libvennratio import venn3
>>> subset_sizes = (100,200,10000,10,20,3,1)
>>> venn3(subset_sizes, layout_algorithm=cost_based.LayoutAlgorithm())
<libvennratio...VennDiagram object at ...>
...
libvennratio._region.VennRegionException: Invalid configuration of circular regions (holes are not supported).
...
from ....\1 import NUMERIC_TOLERANCE
from ....\1.venn3 import pairwise
from ....\1.api import (
    LayoutException,
    Point2D,
    SubsetSizes,
...
def _compute_subset_areas(centers: np.ndarray, radii: np.ndarray) -> SubsetSizes:
    ...
    True
    >>> from libvennratio.layout.venn3 import DefaultLayoutAlgorithm
